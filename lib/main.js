...
export default async function start() {
	...
	let options = yargs
		.usage('Usage: bowerex <command> [options]')
		.example('bowerex checkout user@server:/var/repo.git', 'checks out repo.git and any bower dependencies')
		.help( 'help' )
		.version(function() {
	...
	await g_files.init( options.dir );
	var app = express();
